									...
									<c:forEach items="${groupMetaBeans}" var="group" varStatus="status">
										<tr
											...
											<td nowrap class="right">
												...
												<a href="deleteGroupValue?groupMetaId=${group.groupMetaId}">
													<img src="resources/images/ico_delete.gif" title="Delete" width="18" height="20" class="icon" onclick='deleteGroupValue()'>
												</a>

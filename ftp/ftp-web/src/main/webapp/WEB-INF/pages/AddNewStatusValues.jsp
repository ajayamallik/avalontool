...
<script>
	...
	/* Statusvalues related functions */
	function onSaveStatusValue() {
		alert("Save button clicked....calling ..addNewGroupValues.html");
		document.Form.action = "addNewStatusValues.html";
		document.Form.submit();
	}
	function onSearchStatusValue(){
		alert("Search button clicked....calling ..SearchGroupValues.html");
		document.Form.action = "SearchStatusValues.html";
		document.Form.submit();
	}
	function onUpdateStatusValue(){
		alert("Search button clicked....calling ..updateSearchValues.html");
		document.Form.action = "updateSearchValues.html";  
...
<body>
	...
	<div id="page_container">
		...
		<form:form modelAttribute="statusMetaBean" method="post"  name="Form">
		
		
		 <label class="required_sign"></label>
		<label class="required_sign">
			<c:if test="${statusMetaId != null}">
	      				${statusMetaId}
	     	</c:if>
	     </label> 	
	      <label class="required_sign"></label> 
		<label class="required_sign">
			<c:if test="${statusMetaBeanID != null}">
	      				${statusMetaBeanID}
	     	</c:if>
	     </label> 	
 ...
 -->
							...
							<br>
								...
								<div class="row">
									...
									<div class="frmvaluee">
									<form:hidden path="statusMetaId"/>
									</div>
									
									<div class="frmlabel">
										<label id="jstatus" for="j_status">Enter StatusValues</label>
									</div>
									<div class="frmvaluee">
										<form:input path="statusValues" id="statusValues" />
										<form:errors path="statusValues"  class="required_sign" />
									</div>
									...
									<div class="row">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" value='Save' onclick='onSaveStatusValue()' class="button" /> 
							<input type="button" value='search' onclick='onSearchStatusValue()' class="button" />
							<input type="button" value='Update' onclick='onUpdateStatusValue()' class="button" />		
									</div>

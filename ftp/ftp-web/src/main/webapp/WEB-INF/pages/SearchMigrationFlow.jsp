...
function editMigrationFlow(){
	alert("cliked on edit href...")
}
function deleteMigrationFlow(){
...
<body>
	...
	<div id="page_container">
		...
		<h1>Search Migration Flow </h1>
		<div id="content_main">
			<form:form method="GET" modelAttribute="migrationFlowMetaBean"  name="migrationFlowForm">

				<div class="section_box">
					<div class="section_box_header">
						<h2>Migration Flow Search Results:</h2>
					</div>
					<div>
					...
					<div class="column_single">
						<table class="basic_grid" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<th>MigrationFlow ID</th>
								<th>MigrationFlow </th>
								<th align="right" valign="top" class="right"></th>
							</tr>
							
							<c:choose>
								<c:when test="${not empty migrationFlowMetaBeans}">
									<c:forEach items="${migrationFlowMetaBeans}" var="migflow" varStatus="status">
										<tr
											<c:choose>
											...
											<td>${migflow.migrationFlowId}</td>
											<td>${migflow.migrationFlow}</td>
											<td nowrap class="right">
												...
												<a href="editMigrationFlow?migrationFlowId=${migflow.migrationFlowId}">
													<img src="resources/images/ico_edit.gif" title="Edit" width="18" height="20" class="icon" onclick='editMigrationFlow()'>
												</a>
												...
												<a href="deleteMigrationFlow?migrationFlowId=${migflow.migrationFlowId}">
													<img src="resources/images/ico_delete.gif" title="Delete" width="18" height="20" class="icon" onclick='deleteMigrationFlow()'>
												</a>
